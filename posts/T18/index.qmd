...
Animal health score was 10 prior to ASW-G period but  the mechanical subdivision prior to an ethanol wash and dip disrupted the normal zooid architecture
...
![Example from B1, 40x](t18_b1_2dps_5_0475 Large.jpeg)
          
![Example from B2, 40x](t18_b2_2dps_1_0476 Large.jpeg)

B1 and B2 wells seeded with reabsorbing parental zooids appear to be decaying. Tissue is forming spheres around the edges. 40x magnification at 2 days post seeding.
:::

::: {#fig-Cultrex-TO-A2 layout-ncol=1}

A1 and A2 wells seeded with take over zooids has not put out growth but does not appear to be decaying.
  
![Example from A2, 40x](t18_a2_2dps_4_0458 Large.jpeg)
...
![Tissue 3](t18_a2_13dps_3_0697.jpg){#fig-monolayer-1}

![Tissue 4](t18_a2_13dps_4_0693.jpg){#fig-monolyaer-2}
...
- 09/02/23 (2 dps): For wells A1, A2, B1, B2, 100-90 uL evaporated per well. 
