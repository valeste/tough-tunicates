...
In this small scale experiment, resorbing zooids and take over zooids, two distinct asexual developmental stages sourced from the same *Botryllus* individual, were seeded separately onto 3.8 cm^2^ wells. 
...
**Vessel**: Corning Incorporated 12 well cell culture plate, surface area per well 3.8 cm^2^ (Cat. No. 3513) - Justification: To use various substrate types for the same genotype/individual.
...
-   08/31/23: 10 zooids per well (surface area = 3.8 cm^2^)
    -   2.6 zooids per cm^2^
...
Parental reabsorbing zooid tissue at 2 days post seeding (dps) at 40x magnification B1 and B2 wells, Cultrex BME and Cultrex RGF BME, respectively. Tissue is decaying as evidenced by spheres forming around the edges and the presence of red-ish tissue pieces.  
:::
...
Four monolayer islands occuring from four different tissue pieces at 13 days post seeding on no substrate, 40x magnification. Tissue derived from take over zooids. However, much of this growth was observable 1 day post seeding and has not changed in morphology or size since.
:::
