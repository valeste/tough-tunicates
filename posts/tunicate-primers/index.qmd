...
This method allows you to leverage well-annotated gene data to find potential homologs in Botryllus, even when the genome may not be fully annotated. Keep in mind that this approach is sensible, especially when working with non-model organisms or less-characterized genomes. Just ensure you validate the primers and carry out experimental verification to confirm the presence and function of the genes in Botryllus schlosseri.

#### Pulling *Botryllus schloseri* sequences
...
>>>>>>> f5b9ce93071694f99664fd2e8423a172c0e43aae
