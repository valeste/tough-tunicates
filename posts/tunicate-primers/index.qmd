...
1.  **Start with Gene of Interest:** Identify your gene of interest from a source such as GeneCards. Note that if using GeneCards you will get gene sequences for *Homo sapiens*.
...
4.  **Select Top Sequence:** You identify the top sequence from the BLAST results, which has a significant alignment to your gene of interest. This is a crucial step in confirming the presence of a similar sequence in *Botryllus*.
