...
However, in reviewing Tang's paper, the non-vertebrates referenced as missing collagen 1 in the ECM are primarily Drosophila. Phylogenetically, Drosophila are much more distant relatives to vertebrates than species in the taxa ascidian such as *Botryllus*.

Furthermore, Wei et al. 2017 and Rodriguez et al. 2019 do reference the presence of collagens in the tunics of both solitary and colonial species of ascidians. Particularly in quoting Rodriguez et al. 2019 for *Botryllus*:

>"This tunic has a composition that includes four main macromolecules: collagens, proteoglycans, glycoproteins, and cellulose."

Furthermore, Rabinowitz & Rinkevich 2004 have evidence of epithelial cells from *Botryllus* adhering to and producing monolayers anywhere from 25-50% of the time when using collagen as their substrate.
